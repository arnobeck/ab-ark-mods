<script>
	...
	import { Store_ArkSelectedModList } from "../../../StoreArk.js";
	import Title from "../../../Title.svelte";
	import View from "../../../View.svelte";

	export let data;
	let ArkModList_param = data.ArkModList_param;
	...
	onMount(async () => {
		...
		if (ArkModList_param) {
			// @ts-ignore
			$Store_ArkSelectedModList /** @type {Promise<any[]>} */ =
				await searchModsByIdList(ArkModList_param);
...
<section>
	...
	<ArkModListInput {ArkModList_param} />
	<ArkModListOutput />
	<ArkModList modListDetailed={$Store_ArkSelectedModList} />

	<View modListDetailed={$Store_ArkSelectedModList} />
	<ShareUrl modListDetailed={$Store_ArkSelectedModList} title={data.title} />
</section>
